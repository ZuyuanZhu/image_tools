...
bag_name = 'jackal_zed_small_Fri_1_0.bag'
src_bag = bag_path + bag_name
bag = rosbag.Bag(src_bag, 'r')

# Create a new bag file for writing with modified frame IDs
new_bag = rosbag.Bag(bag_path + 'jackal_zed_small_Fri_1_0_agent_0_frame_id_odom.bag', 'w', compression=rosbag.Compression.NONE)
...
for topic, msg, t in bag.read_messages():
    ...
    if topic == '/zed/zed_node/left/image_rect_color':
